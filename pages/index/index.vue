<template>
	<view class="content">
		...
		<view class="tabBar padding-xl radius shadow shadow-lg bg-white margin-top" :style="{height:is_lhp?'140rpx':'98rpx'}">
			<!-- 导航的中间圆圈 --> 
			<view class="border_box" :style="{paddingBottom:is_lhp?'60rpx':''}">
...
<script>
	import tabGame from '@/components/tabBar/first.vue'
	// import tabDiscovery from '@/components/tabBar/second.vue'
	// import tabInformation from '@/components/tabBar/four.vue'
	import tabData from '@/components/tabBar/third.vue'
	import tabMycenter from '@/components/tabBar/five.vue'
	export default {
		components: {
			tabGame,//比赛    0
			// tabDiscovery,//发现    1
		...
		data() {
			return {
				show_index:0,//控制显示那个组件{'id':3,'name':'购物车'},{'id':1,'name':'分类'}
				tab_nav_list :[{'id':0,'name':'首页'},{'id':2,'name':'推荐'},{'id':4,'name':'我'}],//菜单列表
				is_lhp:false
			}
		},
		onLoad() {
...
<style lang="scss">
	.tabBar{ 
		width:100%;
		height: 100rpx;
		// -moz-box-shadow:0 0 1rpx #1b201e;
		// -webkit-box-shadow:0 0 1rpx #1b201e;
		// box-shadow:0 0 1rpx #1b201e;
		background: #fff;
		border-radius: 50rpx;
